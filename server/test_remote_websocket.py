...
async def test_remote_websocket_connection():
    ...
    try:
        ...
        async with websockets.connect(remote_ws_url, ping_interval=30, ping_timeout=10) as websocket:
                ...
                while asyncio.get_event_loop().time() < end_time:
                    try:
                        ...
                        try:
                            ...
                            print(f"📨 Message {message_count} ({msg_type}): {json.dumps(parsed, indent=2)}")

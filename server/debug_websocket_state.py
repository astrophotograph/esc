    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200:
                ...
                print(f"📡 Registered Telescopes: {health_data.get('registered_telescopes', 0)}")
                ...
                for i, conn in enumerate(connections):
                    ...
                    print(f"   Subscriptions: {json.dumps(conn.get('subscriptions', {}), indent=4)}")
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200:
                ...
                for i, telescope in enumerate(telescopes):
                    ...
                    print(f"   ID/Serial: {telescope.get('id', telescope.get('serial_number'))}")
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200:
                ...
                for controller_key, controller_data in controllers.items():
                    ...
                    print(f"   Host: {controller_data.get('host')}:{controller_data.get('port')}")
                    ...
                    for tel_name, tel_data in telescopes.items():
                        print(f"     - {tel_name}: {tel_data.get('serial_number')} ({'connected' if tel_data.get('connected') else 'disconnected'})")

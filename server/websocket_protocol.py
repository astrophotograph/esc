...
class StatusUpdateMessage(WebSocketMessage):
    ...
    def __init__(self, telescope_id: str, status: Dict[str, Any], changes: Optional[List[str]] = None, **data):
        super().__init__(
...
class MessageFactory:
    ...
    @staticmethod
    def create_status_update(telescope_id: str, status: Dict[str, Any], changes: Optional[List[str]] = None) -> StatusUpdateMessage:
        """Create a status update message."""
        return StatusUpdateMessage(telescope_id=telescope_id, status=status, changes=changes)
    
    @staticmethod
    def create_command_response(telescope_id: str, command_id: str, success: bool, 
                              result: Optional[Dict[str, Any]] = None, error: Optional[str] = None) -> CommandResponseMessage:
    ...
    @staticmethod
    def create_error(error_code: str, error_message: str, telescope_id: Optional[str] = None) -> ErrorMessage:
        """Create an error message."""
        return ErrorMessage(error_code=error_code, error_message=error_message, telescope_id=telescope_id)
    
    @staticmethod
    def create_telescope_discovered(telescope_info: Dict[str, Any]) -> TelescopeDiscoveredMessage:
        """Create a telescope discovered message."""
        return TelescopeDiscoveredMessage(telescope_info=telescope_info)
    
    @staticmethod
    def create_telescope_lost(telescope_id: str, reason: str = "Connection lost") -> TelescopeLostMessage:

...
class TestDatabaseOperationsComprehensive:
    ...
    async def test_delete_configuration(self, db):
        ...
        await db.save_configuration('delete_me', 'To be deleted', json.dumps({'data': 'test'}))
...
class TestDatabaseSchemaValidation:
    ...
    async def test_configuration_schema_validation(self, db):
        ...
        success = await db.save_configuration('simple', 'Simple config', json.dumps(simple_config))
        assert success is True
        ...
        success = await db.save_configuration('complex', 'Complex config', json.dumps(complex_config))
        assert success is True

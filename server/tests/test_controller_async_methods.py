...
@pytest.mark.skipif(not CONTROLLER_ASYNC_AVAILABLE, reason="Controller async methods not available")
class TestControllerAsyncMethods:
    ...
    async def test_load_saved_telescopes_database_error(self, controller):
        ...
        controller.db.load_telescopes.side_effect = Exception("Database connection failed")
    ...
    async def test_connect_all_telescopes_with_connection_failures(self, controller):
        ...
        mock_telescope2.client = AsyncMock()
        mock_telescope2.client.connect = AsyncMock(side_effect=Exception("Connection failed"))
...
class TestControllerTelescoperegistration:
    ...
    @pytest.mark.asyncio
    async def test_telescope_client_registration_with_websocket_manager(self, controller):
        ...
        with patch('websocket_router.websocket_manager') as mock_ws_manager:
            ...
            if mock_telescope.client.is_connected:
                ...
                mock_ws_manager.register_telescope_client(telescope_id, mock_telescope.client)
            ...
            mock_ws_manager.register_telescope_client.assert_called_once_with("SN123456", mock_telescope.client)
            mock_ws_manager.broadcast_status_update.assert_called_once_with("SN123456", {"status": "connected"})
    ...
    async def test_telescope_discovery_broadcast(self, controller):
        ...
        with patch('websocket_router.websocket_manager') as mock_ws_manager:
            ...
            mock_ws_manager.broadcast_telescope_discovered.assert_called_once_with(telescope_info)
    ...
    async def test_telescope_status_event_forwarding(self, controller):
        ...
        with patch('websocket_router.websocket_manager') as mock_ws_manager:
            ...
            mock_ws_manager.broadcast_status_update.assert_called_once_with("SN123456", status_dict)
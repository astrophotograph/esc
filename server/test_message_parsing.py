...
def test_parse_command():
    ...
    parsed = TelescopeMessageParser.parse_message(command_message, datetime.now().isoformat())
...
def test_parse_response():
    ...
    parsed = TelescopeMessageParser.parse_message(response_message, datetime.now().isoformat())
...
def test_parse_event():
    ...
    parsed = TelescopeMessageParser.parse_message(event_message, datetime.now().isoformat())
...
def test_enhanced_response():
    ...
    enhanced_response = TelescopeMessageParser.create_enhanced_response(time_response_data)
...
def test_invalid_json():
    ...
    parsed = TelescopeMessageParser.parse_message(invalid_message, datetime.now().isoformat())
